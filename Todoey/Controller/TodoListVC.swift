...
//    var itemArray = [Item]()
    ...
    //REALM 6.1: Create new instance of Realm
...
//            self.defaults.set(self.itemArray, forKey: self.itemKey)
            ...
            //REALM Step 6.3 Save data to the right category
...
//        loadItems(with: request, predicate: predicate)
        ...
        //REALM 6.5 Searchbar and sorting
